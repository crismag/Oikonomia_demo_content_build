...
Responsibilities and rhythm for each ministry are canonical in `docs/generation/CHURCH-ROLES-AND-MINISTRIES.md`. Team members are listed in each character's **Oikonomia identity** block, not here.
...
Kids, infants, teaching children and child care.
